function [FTrans,rhs] = lhscALC(FTrans,rhs)
...
global aXDen aYDen DX DY fdt G Hux Hvy LASTROW NUMCOLS NUMINCX
global NUMINCY NUMNODES NUMROWS PREC RINC ROWBEGIN ROWEND sLHS
global THETA
...
[d1,d2,d3,d4,rhs] = dOMsYSbOUND(d1,d2,d3,d4,rhs);
